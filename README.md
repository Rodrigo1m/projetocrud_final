...
🎯 Casos de Uso
Novo usuário → Cadastro → Armazenamento no BD
Login → Validação → Acesso ao sistema
Editar usuário → Atualizar dados → Confirmar alterações
Listar usuários → Exibir tabela de usuários
Deletar usuário → Remover do BD
📊 Perfis de Usuário
ADMIN MORHAR
